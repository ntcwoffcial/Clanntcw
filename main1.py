...
# --- FLASK KEEP ALIVE SECTION FOR RENDER ---
app = Flask(__name__)
...
[11EAFD]°°°°ᵀᴺメ₲ûîld BOT°°°°
[FFB300]DEV: NOBITA THE CYBER WARRIOR"""
...
async def encrypted_proto(encoded_hex):
    # Important: Ensure PyCryptodome is installed
                ...
                if data.hex().startswith("120000"):
                    ...
                    if response:
                        ...
                        if inPuTMsG.strip() == "/debug":
                            ...
                            debug_msg = f"[FF0000]✅ ᵀᴺメ₲ûîld BOT ONLINE! UID: {uid}"
...
[FFFFFF]✨ folow on Facebook  
[FFFFFF]          ⚡ nobitathecyberwarrior❤️  
[FFFFFF]                   thank for support 
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]NTCW    
[FFD700]✨ Name on Facebook: [FFFFFF] nobitathecyberwarrior❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> NTCW  ⚡"""
                            else:
                                message = f"""[C][B][FF0000]╔══════════╗
[FFFFFF]✨ folow on Facebook  
[FFFFFF]          ⚡ NTCW❤️  
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]NTCW    
[FFD700]✨ Name on Facebook: [FFFFFF]NTCW❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> NTCW  ⚡"""
                            ...
                            try:
                                ...
                                fallback_msg = "[FF0000]ᵀᴺメ₲ûîld BOT online! Use /help"
                        ...
                        if inPuTMsG.startswith('/stop') and is_admin(uid):
                            ...
                            stop_msg = f"[FF0000]ᵀᴺメ₲ûîld BOT stopping..."
...
async def MaiiiinE():
    ...
    os.system('clear')
    print(render('ᵀᴺメ₲ûîld', colors=['white', 'green'], align='center'))
    print('')
    print(f" - ᵀᴺメ₲ûîld BOT STarTinG And OnLine on TarGet : {TarGeT} | BOT NAME : {acc_name}\n")
    print(f" - BoT sTaTus > GooD | OnLinE ! (:")    
    print(f" - ᵀᴺメ₲ûîld | Bot Uptime: {time.strftime('%H:%M:%S', time.gmtime(time.time() - bot_start_time))}")    
...
if __name__ == '__main__':
    keep_alive()  # Added keep_alive to start Flask in background
